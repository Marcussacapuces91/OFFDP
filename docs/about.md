...
La fiabilisation des données personnelles est au cœur de notre action.  
Nous travaillons à :  

- **Anticiper les risques** grâce à une veille continue sur les pratiques, les réglementations et les technologies.  
- **Objectiver les constats** par la production de preuves tangibles (analyses, tests, démonstrations techniques).  
- **Rendre les droits effectifs** en accompagnant les citoyens et collectifs dans leurs démarches de recours.  
...
- **Transparence** : nos travaux et financements sont documentés et fléchés.  
...
- Nous **alertons** sur les dérives et les failles.  
- Nous **proposons** des solutions proportionnées et réalistes.  
- Nous **accompagnons** les citoyens, les organisations et les institutions.  
